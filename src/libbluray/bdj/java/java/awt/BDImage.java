        ...
        try {
            ...
            AccessController.doPrivileged(
                new PrivilegedAction() {
                    public Object run() {
                        //  reasonably dirty, but the constructor accepts a BufferedImagePeer
//                        Logger.log(false, "BufferedImage: " + Arrays.toString(c.getDeclaredConstructors()));
    ...
    public BufferedImage getSubimage(int x, int y, int w, int h) {
        ...
        int[] rgbArray = getBdBackBuffer();
        getRGB(x, y, w, h, rgbArray, 0, w);
        return createBufferedImage(image);
    }

    public static BufferedImage getBufferedImage(int w, int h, GraphicsConfiguration gc) {
    ...
    { 
        ...
        String filename = dst + "image_c" + counter + "_w" + width + "_h" + height + ".raw";
        counter++;
