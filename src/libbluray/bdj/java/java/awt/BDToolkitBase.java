...
abstract class BDToolkitBase extends Toolkit {
    ...
    {
        logger.info("********* BDToolkitBase:getImage from file: " + filename);
    ...
    {
        logger.info("********* BDToolkitBase:getImage from url: " + url);
    ...
    {
        logger.info("********* BDToolkitBase:createImage from filename: " + filename);
    ...
    {
        logger.info("********* BDToolkitBase:createImage from url: " + url);
    ...
    public Image createImage(byte[] imagedata,
        ...
        logger.info("********* BDToolkitBase:createImage from imagedata");
    ...
    {
//        logger.info("********* BDToolkitBase:createImage from ImageProducer");
    ...
    {
        logger.info("********* BDToolkitBase:createImage from component");
