...
public class BDFontMetrics extends java.awt.FontMetrics {
    ...
    public static native long initN();
    public static native void destroyN(long ftLib);
     ...
     */
    private BDFontMetrics(java.awt.Font font, String nativeName) {
        super(font);
