...
Java_java_awtx_BDFontMetrics_unloadFontConfigN(JNIEnv * env, jclass cls)
{
#ifdef HAVE_FONTCONFIG
...
Java_java_awtx_BDFontMetrics_resolveFontN(JNIEnv * env, jclass cls, jstring jfont_family, jint font_style)
{
...
Java_java_awtx_BDFontMetrics_initN(JNIEnv * env, jclass cls)
{
#ifdef HAVE_FT2
    FT_Library ftLib;
...
JNIEXPORT void JNICALL
Java_java_awtx_BDFontMetrics_destroyN(JNIEnv * env, jclass cls, jlong ftLib)
{
#ifdef HAVE_FT2
    ...
    Java_java_awtx_BDFontMetrics_unloadFontConfigN(env, cls);
#endif
}

JNIEXPORT jobjectArray JNICALL
Java_java_awtx_BDFontMetrics_getFontFamilyAndStyleN(JNIEnv * env, jclass cls, jlong ftLib, jstring fontName)
{
...
JNIEXPORT jlong JNICALL
Java_java_awtx_BDFontMetrics_loadFontN(JNIEnv * env, jobject obj, jlong ftLib, jstring fontName, jint size)
{
#ifdef HAVE_FT2
    const char *name;
    FT_Face ftFace;
...
JNIEXPORT void JNICALL
Java_java_awtx_BDFontMetrics_destroyFontN(JNIEnv *env, jobject obj, jlong ftFace)
{
#ifdef HAVE_FT2
...
Java_java_awtx_BDFontMetrics_charWidthN(JNIEnv * env, jobject obj, jlong ftFace, jchar c)
{
#ifdef HAVE_FT2
    FT_Face face = (FT_Face)(intptr_t)ftFace;
...
JNIEXPORT jint JNICALL
Java_java_awtx_BDFontMetrics_stringWidthN(JNIEnv * env, jobject obj, jlong ftFace, jstring string)
{
#ifdef HAVE_FT2
    jsize length;
    const jchar *chars;
...
JNIEXPORT jint JNICALL
Java_java_awtx_BDFontMetrics_charsWidthN(JNIEnv * env, jobject obj, jlong ftFace, jcharArray charArray,
...
Java_java_awtx_BDFontMetrics_methods[] =
{ /* AUTOMATICALLY GENERATED */
    {
        CC("initN"),
        CC("()J"),
        VC(Java_java_awtx_BDFontMetrics_initN),
    },
    {
        CC("destroyN"),
        CC("(J)V"),
        VC(Java_java_awtx_BDFontMetrics_destroyN),
    },
    {
        CC("resolveFontN"),
        CC("(Ljava/lang/String;I)Ljava/lang/String;"),
        VC(Java_java_awtx_BDFontMetrics_resolveFontN),
    },
    {
        CC("unloadFontConfigN"),
        CC("()V"),
        VC(Java_java_awtx_BDFontMetrics_unloadFontConfigN),
    },
    {
        CC("getFontFamilyAndStyleN"),
        CC("(JLjava/lang/String;)[Ljava/lang/String;"),
        VC(Java_java_awtx_BDFontMetrics_getFontFamilyAndStyleN),
    },
    {
        CC("loadFontN"),
        CC("(JLjava/lang/String;I)J"),
        VC(Java_java_awtx_BDFontMetrics_loadFontN),
    },
    {
        CC("destroyFontN"),
        CC("(J)V"),
        VC(Java_java_awtx_BDFontMetrics_destroyFontN),
    },
    {
        CC("charWidthN"),
        CC("(JC)I"),
        VC(Java_java_awtx_BDFontMetrics_charWidthN),
    },
    {
        CC("stringWidthN"),
        CC("(JLjava/lang/String;)I"),
        VC(Java_java_awtx_BDFontMetrics_stringWidthN),
    },
    {
        CC("charsWidthN"),
        CC("(J[CII)I"),
        VC(Java_java_awtx_BDFontMetrics_charsWidthN),
    },
};

BD_PRIVATE CPP_EXTERN const int
Java_java_awtx_BDFontMetrics_methods_count =
    sizeof(Java_java_awtx_BDFontMetrics_methods)/sizeof(Java_java_awtx_BDFontMetrics_methods[0]);
