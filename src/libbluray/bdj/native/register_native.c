...
int bdj_register_native_methods(JNIEnv *env)
{
    ...
    extern const JNINativeMethod Java_java_awtx_BDGraphics_methods[];
    extern const JNINativeMethod Java_java_awtx_BDFontMetrics_methods[];
    extern const int Java_org_videolan_Logger_methods_count;
    extern const int Java_org_videolan_Libbluray_methods_count;
    extern const int Java_java_awtx_BDGraphics_methods_count;
    extern const int Java_java_awtx_BDFontMetrics_methods_count;
